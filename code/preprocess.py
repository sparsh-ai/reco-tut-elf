...
def read_data(dataset_name, int_per_item):
    ...
    if dataset_name == 'ml-100k':
        ...
        data_dir = 'data/bronze/ml-1m/ratings.dat'
        ...
        data_dir = 'data/bronze/lastfm-2k/user_artists.dat'
        ...
        # Load Yahoo! R3 Data
        data_dir = 'data/bronze/yahoo-r3/ydata-ymusic-rating-study-v1_0-train.txt'
        ...
        # Load Yahoo! R3 Data
        data_dir = 'data/bronze/yahoo-r3/ydata-ymusic-rating-study-v1_0-train.txt'
        test_data_dir = 'data/bronze/yahoo-r3/ydata-ymusic-rating-study-v1_0-test.txt'
        dataset = pd.read_csv(data_dir, sep='\t', header=None, names=['uid', 'mid', 'rating'],  engine='python')
