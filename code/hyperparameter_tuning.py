...
import random
import itertools
from EBPR_model import BPREngine
from preprocess import SampleGenerator, read_data
import argparse
...
def main(args):
    ...
    for hyper_tun_configuration in hyper_tun_configurations:
        for rep in range(num_reps):
            ...
            config = {'model': model_name,
                      ...
                      'model_dir_explicit':'model/checkpoints/{}_Epoch{}_MAP@{}_{:.4f}_NDCG@{}_{:.4f}_MEP@{}_{:.4f}_WMEP@{}_{:.4f}_Avg_Pop@{}_{:.4f}_EFD@{}_{:.4f}_Avg_Pair_Sim@{}_{:.4f}.model',
                      'model_dir_implicit':'model/checkpoints/{}_Epoch{}_NDCG@{}_{:.4f}_HR@{}_{:.4f}_MEP@{}_{:.4f}_WMEP@{}_{:.4f}_Avg_Pop@{}_{:.4f}_EFD@{}_{:.4f}_Avg_Pair_Sim@{}_{:.4f}.model'}
    ...
    if args.save_results:
        results.to_csv('model/Hyperparameter_tuning_' + model_name + '_' + dataset_name + '.csv')
